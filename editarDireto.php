...
$sql = "update tb_aluno set cgm='$cgm', ano='$ano',turma='$turma',nome='$nome',nascimento='$nascimento',sexo='$sexo',situacaoMatricula='$situacao',dataMatricula='$matriculado',observacao='$observacao',dificuldade='$dificuldade' where cgm = '$cgm'"; 
