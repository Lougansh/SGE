				...
				<div align="center">
					<br><table border="0">
						...
						<tr>
							...
							<td>
								<input style="text-align:center" type="text" size="1" name="textDia">
								<input style="text-align:center" type="text" size="1" name="textMes">
								<input style="text-align:center" type="text" size="3" name="textAno"> 
							</td>
						</tr>
						<tr>
