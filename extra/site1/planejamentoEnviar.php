...
if (isset($_POST['ano'])){
	...
	$sql = 'SELECT * from tb_planejamentoMFT where turma = '.$anoSelect.' order by ID desc';
...
if (isset($_POST['conteudo'])){
	...
	$sql = 'SELECT * from tb_planejamentoMFT where turma = '.$anoSelect.' and ID = '.$conteudoSelect.' order by ID desc';
	$query = mysql_query($sql) or die("SQL:" . $sql . " - ERRO:" . mysql_error());
...
if (isset($_POST['btnSalvar'])){
	...
	$sql = "update tb_planejamentoMFT set Objetivo = '$upObjetivo', Encaminhamento = '$upEncaminhamento', Recurso = '$upRecurso' where Turma = '$upAno' and ID = '$upConteudo'";
	$query = mysql_query($sql) or die("SQL:" . $sql . " - ERRO:" . mysql_error());
	mysql_free_result($query);
