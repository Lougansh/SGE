...
$sql = 'select * from tb_alunoMFT where situacao = "A" and ano >= 5 Order By turma, nomeAluno asc';
...
//=====================================================================================
$sql = "SELECT * FROM tb_aluno_projeto WHERE local = 'MFT' and anoProjeto = YEAR(CURDATE()) and turma <> '' order by equipe desc, nomeAluno desc";
$query = mysql_query($sql) or die("SQL:" . $sql . " - ERRO:" . mysql_error());
$meninasManha = 0;
$meninasTarde = 0;
$meninasRemoto = 0;
...
$meninasTotal = $meninasManha+$meninasTarde+$meninasRemoto;
$meninosTotal = $meninosManha+$meninosTarde+$meninasRemoto;
