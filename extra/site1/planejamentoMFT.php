...
$conteudoID = 0;
$titulo = '<div align="center"><h3>PLANEJAMENTO PEDAGÓGICO - '.$anoTurma.'</h3></div>';
	$sql = 'SELECT * from tb_planejamentoMFT where turma = '.$_SESSION["ano"].' order by ID asc';
...
elseif (isset($_POST['btnPesquisar'])){
	...
	$sql = 'SELECT * from tb_planejamentoMFT where turma = '.$_SESSION["ano"].' and '.$coluna.' like "%'.$assunto.'%" order by ID desc';
