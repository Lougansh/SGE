...
<div align="center"><table border="0" width="90%">
		<tr>
			<td rowspan="14" align="center" valign="top" width="315"><hr width="10%"><hr width="30%"><hr width="50%">
		...
		<tr>
			<td align="right" width="116" >Login:</td>
			<td colspan="2">
				<input style="text-align:left" type="text" value="'.$linha['login'].'" size="30" name="login">
				Senha: 
				<input style="text-align:center" type="text" value="'.$linha['senha'].'" size="8" name="senha">
				Chave: 
				<input style="text-align:center" type="text" value="'.$linha['chave'].'" size="15" name="chave">
				PC: 
				<input style="text-align:center" type="text" value="'.$linha['pc'].'" size="2" name="pc"></td>
		</tr>
		<tr>
