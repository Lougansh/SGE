...
<td width="39">'.$dataInicio.'</td><td width="15"><p align="center"><font size="4">a </font></td>
<td width="39"><font size="4"> '.$dataFim.'</font></td><td width="750">&nbsp;</td></tr></table></div>
...
<td><img border="0" src="../images/Turmas/pre.gif" width="140" height="50"></td><td>
<textarea rows="4" name="recurso0" cols="80">'.$conteudo0.'</textarea></td></tr><tr>
<td><img border="0" src="../images/Turmas/1.gif"   width="140" height="50"></td><td>
<textarea rows="4" name="recurso1" cols="80">'.$conteudo1.'</textarea></td></tr><tr>
<td><img border="0" src="../images/Turmas/2.gif"   width="140" height="50"></td><td>
<textarea rows="4" name="recurso2" cols="80">'.$conteudo2.'</textarea></td></tr><tr>
<td><img border="0" src="../images/Turmas/3.gif"   width="140" height="50"></td><td>
<textarea rows="4" name="recurso3" cols="80">'.$conteudo3.'</textarea></td></tr><tr>
<td><img border="0" src="../images/Turmas/4.gif"   width="140" height="50"></td><td>
<textarea rows="4" name="recurso4" cols="80">'.$conteudo4.'</textarea></td></tr><tr>
<td><img border="0" src="../images/Turmas/5.gif"   width="140" height="50"></td><td>
<textarea rows="4" name="recurso5" cols="80">'.$conteudo5.'</textarea></td></tr></table></div>
